...
const eventsData = [
  {
    ...
    name: '进入大学',
    description: '',
    content: '<p><span class="highlight">2021 年秋天</span>，我们的潘哥拖着行李箱走进了大学校门。那天天气很好，阳光透过树荫洒在迎新大道上，到处都是举着牌子的学长学姐。</p><p>刚来南昌的时候宿舍还只有两个人，我相信潘哥永远忘不了王哥喊的口令以及三食堂吃出来的那只蟑螂。</p>',
  ...
  },
  {
    ...
    name: '拼多多现金红包已到账',
    description: '点击查看详情',
    content: '<p>关于这件事，我相信我不用介绍太多，看得到这个网站的各位大概率都是<span class="highlight">"拼多多现金红包已到账"</span>的见证者，我们至今仍然不知道潘哥的现金红包拿到了多少钱。</p>',
  ...
  },
  {
    ...
    name: '疫情隔离',
    description: '',
    content: '<p><span class="highlight">2022 年</span>，大学生活被疫情切割成了一段一段的。封校、网课、核酸、每日打卡……这些词成了日常。</p><p>在宿舍上网课的日子，其实也有它的好。躺在床上就能上课了（到底听没听你别问），吃饭也不用挤食堂。但长时间被困在小小的宿舍里，人确实会变得压抑，所以潘哥开始了他在地平线 4 的旅途。</p><p>记得解封那天，我和潘哥排了四十分钟的队买了三份浓汁烧，还带了三瓶冰可乐，浓汁烧什么味道我也忘记了，只记得那天太阳很大，空气湿湿的搞得我不是很想去食堂吃。</p>',
    images: []
  },
  {
    year: 2022, number: 2,
    name: '南昌丁俊晖的诞生',
    description: '',
    content: '<p>解封之后我们闲着没事瞎逛，在食堂三楼看到了健身房和四张台球桌，但当时的我们并不知道，<span class="highlight">台球界一颗璀璨的新星</span>正在我们身边悄然升起，我稍微放一个小片段大家就能感觉到实力了。</p>',
    images: []
  },
  {
    year: 2023, number: 1,
    name: '入坑塞尔达传说',
    description: '',
    content: '<p>大概是潘哥开始死磕初会之前的时间，他霸占了我的 switch，大半夜会因为搞到一把大剑很开心的给我发微信，<span class="highlight">现在想想那种很纯粹的因为游戏带来的开心</span>好像也慢慢开始找不到了。</p>',
  ...
  },
  {
    ...
    name: '去了趟福州',
    description: '',
    content: '<p>去了三坊七巷，烟台山，长乐（虽然我不知道长乐除了看海还有啥好玩的）吃了鱼丸、肉燕，但是福州大部分食物吃起来都不辣，估计潘哥是吃不惯哈哈哈。</p><p>潘哥来福州的时候正值年后，是福州人游神的时间，我带他去看了次游神，还带去清富的高中看了看，也算是圣地巡礼了，现在也记不太清了具体做了啥，只记得吃了披萨还有大半夜喝了霸王茶姬然后睡不着觉了。</p>',
    images: []
  },
  {
    year: 2025, number: 1,
    name: '歌神的诞生',
    description: '',
    content: '<p>具体七七八八的就不写了，放两段各位自己感受。</p>',
  ...
  },
  {
    ...
    name: '又去了一次福州',
    description: '',
    content: '<p>这次是我带潘哥去的福州，想着带他玩几天呢，结果潘哥抽到了盲审，在我家熬了三个通宵…</p>',
  ...
  },
  {
    ...
    name: '毕业',
    description: '',
    content: '<p>全程心里都飘着一首歌<span class="highlight">"又到凤凰花朵开放的时候"</span>，虽然每天看起来其乐融融，但是故事的最后是一抹离别的灰色，发生了很多事，吃了很多顿好的，后来遇到阳光明媚的午后总会觉得仿佛还在学校马上就要一起去吃饭，想起来要拍一张照片留念。</p>',
